	...
	<div class="main_content">
		...
		<div class="content_right">
			<table cellspacing="0" cellpadding="0">
				<tr style="height:50px; background:url('images/content-bg.gif') repeat-x;">
					<td style="height:50px;width:17px;background: url('images/left-top-right.gif') no-repeat;"></td>
					<td style="height:50px;line-height:50px;"><div class="content_title">首页</div></td>
					<td style="height:50px;width:16px;background: url('images/nav-right-bg.gif') no-repeat;"></td>
				</tr>
				<tr>
					<td style="background:url('images/mail_leftbg.gif') repeat-y;"></td>
					<td style="background-color:#FAFBFD;height:670px;">
			...
			<div class="sys_bottom"> Copyright &copy; 2015 游戏BI管理系统</div>
		</div>
	</div>
...
function initRightContentHeightAndWidth(){
	...
	$(".content_right table").width(width-$(".content_left").width());
	$(".content_right table tr:eq(1) td").height(height-$(".main_header").height()-$(".sys_bottom").height()-76);
}
